    ...
    const handleSubmit = async (e) => {
        ...
        if (errorMessage) {
            ...
            try {
                ...
                setErrorOverall(error.response?.data?.message || 'Failed to send OTP. Please try again.');
            } finally {
    ...
    return (
        ...
        >
            <div className="p-2">
                ...
                <p className="text-gray-600 text-xs mb-6">Enter your email address to receive OTP.</p>
