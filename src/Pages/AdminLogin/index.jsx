                ...
                <div className="w-full max-w-md space-y-3 bg-white p-8 rounded-2xl shadow-xl">
                    ...
                    <form onSubmit={handleSubmit} className="mt-4 space-y-3">
                        ...
                        <button
                            ...
                            className={`w-full text-xs font-bold bg-purple-600 text-white py-3 rounded-lg transition-all duration-200 transform hover:scale-[1.02] cursor-pointer ${isSubmitting ? 'opacity-70 cursor-not-allowed' : 'hover:bg-purple-700'
                                }`}
                        >
