...
const VendorDashboard = () => {
  ...
  const viewsData = {
    ...
    yearly: {
      ...
      data: [5000, 6000, 4500, 7000, 6500, 8000, 7500, 9000, 8500, 7800, 8200, 9500]
    }
  };
          ...
          <Bar 
            ...
            options={{
              ...
              plugins: {
                ...
                title: {
                  display: true,
                  text: `${viewsPeriod.charAt(0).toUpperCase() + viewsPeriod.slice(1)} Views`,
                },
              },
            }}
          />
          ...
          <Pie 
            ...
            options={{
              ...
              plugins: {
                ...
                title: {
                  display: true,
                  text: `${reviewsPeriod.charAt(0).toUpperCase() + reviewsPeriod.slice(1)} Reviews`,
                },
              },
            }}
          />
